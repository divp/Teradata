...
where
    d.d_date >= '2001-02-01' and 
         d.d_date <= date_add('2001-02-01',60)
and e.ca_state = 'MO' 
and f.cc_county in ('Dauphin County','Jefferson Davis Parish','Oglethorpe County','Walker County', 'Fairfield County')
