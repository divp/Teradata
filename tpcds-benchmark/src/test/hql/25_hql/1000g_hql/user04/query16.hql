...
where
    d.d_date >= '2000-02-01' and 
         d.d_date <= date_add('2000-02-01',60)
and e.ca_state = 'OK' 
and f.cc_county in ('Richland County','Fairfield County','Oglethorpe County','Huron County', 'Kittitas County')
