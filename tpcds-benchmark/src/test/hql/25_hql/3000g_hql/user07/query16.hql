...
where
    d.d_date >= '2002-03-01' and 
         d.d_date <= date_add('2002-03-01',60)
and e.ca_state = 'VA' 
and f.cc_county in ('Oglethorpe County','Ziebach County','Wadena County','Williamson County', 'Walker County')
