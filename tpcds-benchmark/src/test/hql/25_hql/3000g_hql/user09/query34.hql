...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and (hd.hd_buy_potential = '501-1000' or
    ...
    and s.s_county in ('Jefferson Davis Parish','Contra Costa County','Huron County','Raleigh County','Perry County','Walker County','Hubbard County','Franklin Parish')
