...
from (
    ...
    (select
        ...
        ,d_year as yearx
        ,sum(case when d_moy = 1
                then [SALESONE] *ws_quantity else cast(0 as decimal) end) as jan_sales
        ,sum(case when d_moy = 2
                then [SALESONE] *ws_quantity else cast(0 as decimal) end) as feb_sales
        ,sum(case when d_moy = 3
                then [SALESONE] *ws_quantity else cast(0 as decimal) end) as mar_sales
        ,sum(case when d_moy = 4
                then [SALESONE] *ws_quantity else cast(0 as decimal) end) as apr_sales
        ,sum(case when d_moy = 5
                then [SALESONE] *ws_quantity else cast(0 as decimal) end) as may_sales
        ,sum(case when d_moy = 6
                then [SALESONE] *ws_quantity else cast(0 as decimal) end) as jun_sales
        ,sum(case when d_moy = 7
                then [SALESONE] *ws_quantity else cast(0 as decimal) end) as jul_sales
        ,sum(case when d_moy = 8
                then [SALESONE] *ws_quantity else cast(0 as decimal) end) as aug_sales
        ,sum(case when d_moy = 9
                then [SALESONE] *ws_quantity else cast(0 as decimal) end) as sep_sales
        ,sum(case when d_moy = 10
                then [SALESONE] *ws_quantity else cast(0 as decimal) end) as oct_sales
        ,sum(case when d_moy = 11
                then [SALESONE] *ws_quantity else cast(0 as decimal) end) as nov_sales
        ,sum(case when d_moy = 12
                then [SALESONE] *ws_quantity else cast(0 as decimal) end) as dec_sales
        ,sum(case when d_moy = 1
                then [NETONE] *ws_quantity else cast(0 as decimal) end) as jan_net
        ,sum(case when d_moy = 2
                then [NETONE] *ws_quantity else cast(0 as decimal) end) as feb_net
        ,sum(case when d_moy = 3
                then [NETONE] *ws_quantity else cast(0 as decimal) end) as mar_net
        ,sum(case when d_moy = 4
                then [NETONE] *ws_quantity else cast(0 as decimal) end) as apr_net
        ,sum(case when d_moy = 5
                then [NETONE] *ws_quantity else cast(0 as decimal) end) as may_net
        ,sum(case when d_moy = 6
                then [NETONE] *ws_quantity else cast(0 as decimal) end) as jun_net
        ,sum(case when d_moy = 7
                then [NETONE] *ws_quantity else cast(0 as decimal) end) as jul_net
        ,sum(case when d_moy = 8
                then [NETONE] *ws_quantity else cast(0 as decimal) end) as aug_net
        ,sum(case when d_moy = 9
                then [NETONE] *ws_quantity else cast(0 as decimal) end) as sep_net
        ,sum(case when d_moy = 10
                then [NETONE] *ws_quantity else cast(0 as decimal) end) as oct_net
        ,sum(case when d_moy = 11
                then [NETONE] *ws_quantity else cast(0 as decimal) end) as nov_net
        ,sum(case when d_moy = 12
                then [NETONE] *ws_quantity else cast(0 as decimal) end) as dec_net
     from
          web_sales ws
...
union all
    select
        ...
        ,d_year as yearx
        ,sum(case when d_moy = 1
                then [SALESTWO] *cs_quantity else cast(0 as decimal) end) as jan_sales
        ,sum(case when d_moy = 2
                then [SALESTWO] *cs_quantity else cast(0 as decimal) end) as feb_sales
        ,sum(case when d_moy = 3
                then [SALESTWO] *cs_quantity else cast(0 as decimal) end) as mar_sales
        ,sum(case when d_moy = 4
                then [SALESTWO] *cs_quantity else cast(0 as decimal) end) as apr_sales
        ,sum(case when d_moy = 5
                then [SALESTWO] *cs_quantity else cast(0 as decimal) end) as may_sales
        ,sum(case when d_moy = 6
                then [SALESTWO] *cs_quantity else cast(0 as decimal) end) as jun_sales
        ,sum(case when d_moy = 7
                then [SALESTWO] *cs_quantity else cast(0 as decimal) end) as jul_sales
        ,sum(case when d_moy = 8
                then [SALESTWO] *cs_quantity else cast(0 as decimal) end) as aug_sales
        ,sum(case when d_moy = 9
                then [SALESTWO] *cs_quantity else cast(0 as decimal) end) as sep_sales
        ,sum(case when d_moy = 10
                then [SALESTWO] *cs_quantity else cast(0 as decimal) end) as oct_sales
        ,sum(case when d_moy = 11
                then [SALESTWO] *cs_quantity else cast(0 as decimal) end) as nov_sales
        ,sum(case when d_moy = 12
                then [SALESTWO] *cs_quantity else cast(0 as decimal) end) as dec_sales
        ,sum(case when d_moy = 1
                then [NETTWO] *cs_quantity else cast(0 as decimal) end) as jan_net
        ,sum(case when d_moy = 2
                then [NETTWO] *cs_quantity else cast(0 as decimal) end) as feb_net
        ,sum(case when d_moy = 3
                then [NETTWO] *cs_quantity else cast(0 as decimal) end) as mar_net
        ,sum(case when d_moy = 4
                then [NETTWO] *cs_quantity else cast(0 as decimal) end) as apr_net
        ,sum(case when d_moy = 5
                then [NETTWO] *cs_quantity else cast(0 as decimal) end) as may_net
        ,sum(case when d_moy = 6
                then [NETTWO] *cs_quantity else cast(0 as decimal) end) as jun_net
        ,sum(case when d_moy = 7
                then [NETTWO] *cs_quantity else cast(0 as decimal) end) as jul_net
        ,sum(case when d_moy = 8
                then [NETTWO] *cs_quantity else cast(0 as decimal) end) as aug_net
        ,sum(case when d_moy = 9
                then [NETTWO] *cs_quantity else cast(0 as decimal) end) as sep_net
        ,sum(case when d_moy = 10
                then [NETTWO] *cs_quantity else cast(0 as decimal) end) as oct_net
        ,sum(case when d_moy = 11
                then [NETTWO] *cs_quantity else cast(0 as decimal) end) as nov_net
        ,sum(case when d_moy = 12
                then [NETTWO] *cs_quantity else cast(0 as decimal) end) as dec_net
     from
          catalog_sales cs
