...
from
 ...
 where t.t_hour = 8
     and t.t_minute >= 30
     and ((hd.hd_dep_count = [HOUR.1] and hd.hd_vehicle_count<=[HOUR.1]+2) or
          (hd.hd_dep_count = [HOUR.2] and hd.hd_vehicle_count<=[HOUR.2]+2) or
          (hd.hd_dep_count = [HOUR.3] and hd.hd_vehicle_count<=[HOUR.3]+2))
