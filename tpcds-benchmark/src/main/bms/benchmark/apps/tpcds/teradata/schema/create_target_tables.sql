...
CREATE MULTISET TABLE ship_mode ,NO FALLBACK ,
     ...
     (
      ...
      sm_ship_mode_id CHAR(16) CHARACTER SET LATIN NOT CASESPECIFIC NOT NULL,
...
CREATE MULTISET TABLE call_center ,NO FALLBACK ,
     ...
     (
      ...
      cc_call_center_id CHAR(16) CHARACTER SET LATIN NOT CASESPECIFIC NOT NULL,
...
CREATE MULTISET TABLE warehouse ,NO FALLBACK ,
     ...
     (
      ...
      w_warehouse_id CHAR(16) CHARACTER SET LATIN NOT CASESPECIFIC NOT NULL,
...
CREATE MULTISET TABLE catalog_page ,NO FALLBACK ,
     ...
     (
      ...
      cp_catalog_page_id CHAR(16) CHARACTER SET LATIN NOT CASESPECIFIC NOT NULL,
...
CREATE MULTISET TABLE web_page ,NO FALLBACK ,
     ...
     (
      ...
      wp_web_page_id CHAR(16) CHARACTER SET LATIN NOT CASESPECIFIC NOT NULL,
