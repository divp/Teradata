...
where
    d.d_date >= '2001-04-01' and 
         d.d_date <= date_add('2001-04-01',60)
and e.ca_state = 'IA' 
and f.cc_county in ('Fairfield County','Wadena County','Oglethorpe County','Franklin Parish', 'San Miguel County')
