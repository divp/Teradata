...
where
    d.d_date >= '2002-04-01' and 
         d.d_date <= date_add('2002-04-01',60)
and e.ca_state = 'UT' 
and f.cc_county in ('Franklin Parish','San Miguel County','Ziebach County','Pennington County', 'Barrow County')
