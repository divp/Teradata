...
where
    d.d_date >= '2000-04-01' and 
         d.d_date <= date_add('2000-04-01',60)
and e.ca_state = 'NC' 
and f.cc_county in ('Oglethorpe County','Raleigh County','San Miguel County','Richland County', 'Mobile County')
