...
where
    d.d_date >= '1999-03-01' and 
         d.d_date <= date_add('1999-03-01',60)
and e.ca_state = 'PA' 
and f.cc_county in ('Wadena County','Pennington County','Mobile County','San Miguel County', 'Jackson County')
